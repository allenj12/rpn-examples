...
(:v overlap? prep-compare start between rrot 
             ...
             extract-prior dup3 end between 4rot (2 or))
...
(: insert-interval swap '() (2 cons)
    (rpnlv overlap?
        (rpnl swap split rot merge swap (2 cons))
        (rpnl swap split rot order-pairs rot (2 cons) (2 cons))
        2rif)
    rot fold1)

(scheme-start
 (rpnlv '(4 8) '((1 2) (3 5) (6 7) (8 10) (12 16)) insert-interval))
